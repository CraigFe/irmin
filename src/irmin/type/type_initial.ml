...
(** This module defines a private, non-extensible, initial interpretation of the
    DSL defined in {!Type_dsl} that is used within this library. *)

include Type_initial_intf
include Type_initial_intf.Types
open Staging
open Brands
